...
def CoreNet(ix, path):
    ...
    x = Conv2D(1024, (32, 32), strides=4, dilation_rate=1, padding='same', activation='relu', name=path + 'Conv')(ix)
...
model.summary(line_length=None,
              positions=None,
              print_fn=None)
tf.keras.utils.plot_model(model, to_file='/plot/save/path/VM_v3.6.0.png', show_shapes=True, show_layer_names=True, rankdir='TB')
