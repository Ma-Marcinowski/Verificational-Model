...
x = tf.keras.layers.concatenate([x, c, e], axis=-1)
...
model.summary(line_length=None,
              positions=None,
              print_fn=None)
tf.keras.utils.plot_model(model, to_file='/plot/save/path/VM_v2.6.5b.png', show_shapes=True, show_layer_names=True, rankdir='TB')
