...
left_input = Input(shape=(1024, 1024, 1), name='left_input')
right_input = Input(shape=(1024, 1024, 1), name='right_input')
...
model.summary(line_length=None,
              positions=None,
              print_fn=None)
tf.keras.utils.plot_model(model, to_file='/path/VM_v1.1.2.png', show_shapes=True, show_layer_names=True, rankdir='TB')
