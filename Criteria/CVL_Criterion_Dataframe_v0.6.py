...
def Dataframe(img_path, df_path, df_img_path):
    ...
    with open(df_path, 'a+') as f:
        ...
        for j in tqdm(pngs, leave=False):
            for i in pngs:
                ...
                if j[:8] == i[:8] and j[0] in ('c') and i[0] in ('c') and (j, i) not in rev:
        ...
        while neg < pos:
            ...
            print('Done CVL criterion negatives: ', neg, ' instances.')
    ...
    print('Done CVL criterion dataframe: ', df.shape[0], ' image pairs.')

CVL_Criterion_Dataframe = Dataframe(img_path='/preprocessed/test/images/directory/',
                                    df_path='/dataframe/save/directory/CVL_Criterion_Dataframe.csv',
