...
x = Dense(1024, activation='relu', kernel_regularizer=l2(l=0.01), name='1stFCL')(x)
x = GaussianDropout(rate=0.2)(x)
x = Dense(512, activation='relu', kernel_regularizer=l2(l=0.01), name='2ndFCL')(x)
x = GaussianDropout(rate=0.2)(x)
...
model.summary(line_length=None, 
              positions=None,
              print_fn=None)
tf.keras.utils.plot_model(model, to_file='/content/VM_VGG13_var1.png', show_shapes=True, show_layer_names=True, rankdir='TB')
