...
xl = Conv2D(64, (3, 3), strides=2, padding='same', input_shape=(256, 256, 1), name='1stConvLeft')(left_input)
xl = BatchNormalization(axis=-1, scale=False, trainable=True)(xl)
xl = Activation('relu')(xl)
xl = MaxPooling2D(pool_size=(2, 2), strides=2, padding='valid', name='1stPoolLeft')(xl)

xl = Conv2D(128, (3, 3), strides=1, padding='same', name='2ndConvLeft')(xl)
xl = BatchNormalization(axis=-1, scale=False, trainable=True)(xl)
xl = Activation('relu')(xl)
xl = MaxPooling2D(pool_size=(2, 2), strides=2, padding='valid', name='2ndPoolLeft')(xl)

xl = Conv2D(256, (3, 3), strides=1, padding='same', name='3rdConvLeft')(xl)
xl = BatchNormalization(axis=-1, scale=False, trainable=True)(xl)
xl = Activation('relu')(xl)
xl = MaxPooling2D(pool_size=(2, 2), strides=2, padding='valid', name='3rdPoolLeft')(xl)

xl = Conv2D(512, (3, 3), strides=1, padding='same', name='4thConvLeft')(xl)
xl = BatchNormalization(axis=-1, scale=False, trainable=True)(xl)
xl = Activation('relu')(xl)
left_out = MaxPooling2D(pool_size=(2, 2), strides=2, padding='valid', name='4thPoolLeft')(xl)


xr = Conv2D(64, (3, 3), strides=2, padding='same', input_shape=(256, 256, 1), name='1stConvRight')(right_input)
xr = BatchNormalization(axis=-1, scale=False, trainable=True)(xr)
xr = Activation('relu')(xr)
xr = MaxPooling2D(pool_size=(2, 2), strides=2, padding='valid', name='1stPoolRight')(xr)

xr = Conv2D(128, (3, 3), strides=1, padding='same', name='2ndConvRight')(xr)
xr = BatchNormalization(axis=-1, scale=False, trainable=True)(xr)
xr = Activation('relu')(xr)
xr = MaxPooling2D(pool_size=(2, 2), strides=2, padding='valid', name='2ndPoolRight')(xr)

xr = Conv2D(256, (3, 3), strides=1, padding='same', name='3rdConvRight')(xr)
xr = BatchNormalization(axis=-1, scale=False, trainable=True)(xr)
xr = Activation('relu')(xr)
xr = MaxPooling2D(pool_size=(2, 2), strides=2, padding='valid', name='3rdPoolRight')(xr)

xr = Conv2D(512, (3, 3), strides=1, padding='same', name='4thConvRight')(xr)
xr = BatchNormalization(axis=-1, scale=False, trainable=True)(xr)
xr = Activation('relu')(xr)
