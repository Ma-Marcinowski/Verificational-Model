...
* #### 3.13. Model 2.6.0 cumulative evaluation on [256x256] patches (extended train database of ??? images)
  ...
  * 3.13.2. Model:
    ...
    * However another test dataframe is generated by a method of preprocessing v0.6, for the purpose of cumulative evaluation. 
...
* #### 3.13. Model 2.7.0 cumulative evaluation on [256x256] patches (extended train database of ??? images)    
