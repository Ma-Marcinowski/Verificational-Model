...
* #### 3.?. Model v2.3.0 training on [256x256] patches (extended train database)
  ...
  * 3.?.2. Database:
    ...
    * Training dataset - a subset of combined CVL and IAM databases, containing 2740 document images (1415 from CVL and 1325 from IAM) by 822 writers (283 from CVL and 539 from IAM) - 3535057 image pairs (equal number of positive and negative instances);
...
* #### 3.?. Model v2.3.0 evaluation on [256x256] patches (extended test database)
  ...
  * 3.?.3. Database:
    ...
    * Test dataset - a subset of combined CVL and IAM databases, containing 403 document images (189 from CVL and 214 from IAM) by 145 writers (27 from CVL and 118 from IAM) - 405307 image pairs (equal number of positive and negative instances).  
