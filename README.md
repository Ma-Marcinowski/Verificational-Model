...
* #### 4.6. Model v3.6.2 transfer training on [256x256] patches (extended train database of raw grayscaled images)
  ...
  * 4.6.3. Training:
    ...
    | 7 | IAM | None | 0.2272 | 0.9094 | 0.2924 | 0.8847 | Manual LR reduction to 0.00001 (1e-5) |
    | 8 | **IAM** | None | 0.2190 | 0.9131 | **0.2811** | **0.8894** | Manual LR reset to 0.0001 (1e-4) |
    | 9 | Both | None | 0. | 0. | 0. | 0. | None |
