...
### 1. Preprocessing
   ...
   * #### 1.1. Objective, assumptions, database and steps of preprocessing
     ...
     * 1.1.1. Objective of repository author's was to prepare a method of image preprocessing for verification of handwritten documents authorship by artificial neural network (through ANN classification of image pairs to positive `same author` or negative `different authors` class).
