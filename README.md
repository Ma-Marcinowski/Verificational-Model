...
* #### 2.1. Model
  ...
  * 2.1.3. Implementation:
    ...
    * Google Colaboratory - Python 3 Jupyter Notebook, GPU type runtime (2019)- 290ms/step (27732 steps per epoch);
        
    * Kaggle - Python 3 Jupyter Notebook, GPU type runtime (2019) - 65ms/step (27732 steps per epoch).
