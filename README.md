...
* #### 3.14. Model v2.5.1 evaluation on [256x256] patches (extended train database of raw grayscaled images)
  ...
  * 3.14.7. Model v2.5.1 categorized evaluation on [256x256] patches (extended train database of raw grayscaled images)
    ...
    | Dextral | 136390 | 0. | 0. | 0. | 0. | 0. | 0. | 0. | 0. | 0. |
    | Feminine sinistral | 10094 | 0. | 0. | 0. | 0. | 0. | 0. | 0. | 0. | 0. |
    | Feminine dextral | 66660 | 0. | 0.| 0. | 0. | 0. | 0. | 0. | 0. | 0. |
    ...
    | Random | 136390 | 0. | 0. | 0. | 0. | 0. | 0. | 0. | 0. | 0. |
    | Random | 10094 | 0. | 0.| 0. | 0. | 0. | 0. | 0. | 0. | 0. |
    | Random | 66660 | 0. | 0.| 0. | 0. | 0. | 0. | 0. | 0. | 0. |
