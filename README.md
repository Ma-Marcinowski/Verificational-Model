...
* #### 1.3.3. Dataframes are generated exatly the same way as in the case of v0.2 and v0.1, except for the optional split of training dataframe into a given number of smaller equal size training dataframes, due to the sheer number of training image pairs.
...
* #### 3.?. Model v2.3.0 training on [256x256] patches (extended train database)
  ...
  * 3.?.2. Database:
    ...
    * Training dataset - a subset of combined CVL and IAM databases, containing 2740 document images (1415 from CVL and 1325 from IAM) by 822 writers (283 from CVL and 539 from IAM) - 3493614 image pairs (equal number of positive and negative instances);
