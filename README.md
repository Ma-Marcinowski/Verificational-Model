 ...
 * 3.14.8. The probability of the evaluation results occuring
  ...
  * 3.14.9. Model v2.5.1 categorized evaluation on [256x256] patches (extended train database of raw grayscaled images)
    ...
    | PARO | Authors sample |  Category | Loss | Acc | TPR | TNR | FPR | FNR | PPV | NPV | AUC |
    | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
    ...
    | 0.7150 | 79 | Masculine | 0.1094 | 0.9634 | 0.9655 | 0.9614 | 0.0386 | 0.0345 | 0.9616 | 0.9653 | 0.9918 |
    ...
    | **0.0392** | 9 | **Feminine Sinistral** | **0.3308** | **0.9151** | **0.8419** | **0.9883** | 0.0117 | 0.1581 | 0.9863 | 0.8621 | 0.9717 |
    | **0.0510** | 14 | **Masculine Sinistral** | **0.1289** | **0.9485** | **0.9806** | **0.9165** | 0.0835 | 0.0194 | 0.9215 | 0.9792 | 0.9911 | 
    ...
    * Probability of the Acc randomly occuring - PARO - given: the authors sample size, limit of sample combinations (100), and the range of the expected Acc (±0.50).  
