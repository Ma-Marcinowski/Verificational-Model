...
* #### 4.3. Model v3.6.1
  ...
  * 4.3.3. Implementation:
    ...
    * Google Colaboratory - (2019) - Python 3 Jupyter Notebook, GPU type runtime (Nvidia Tesla K80), 157ms/step (93016 steps per epoch) in the case of model v3.6.1 training on [256x256] patches.   
...
* #### 4.6. Model v3.6.2 transfer training on [256x256] patches (extended train database of raw grayscaled images)
  ...
  * 4.6.4. Errors:
     ...
     * During the training epochs 2 through 3, an error in loading the saved (between epochs) optimizer states occured, hence, the optimizer was freshly initialized at the beginning of each of those epochs.
