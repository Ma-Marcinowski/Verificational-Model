...
* #### 3.12. Model v2.5.0 evaluation on [256x256] patches (extended train database of grayscaled and noised images)
  ...
  * 3.12.3. CVL and IAM evaluation:
    ...
    | **Negative** | 5 | 0.0476| **.9815** | None | 0.9815 | 0.0185 | None | None | None | None |
    | **Average** | 5 | 0.1540 | **0.9556** | 0.9571 | 0.9539 | 0.0460 | 0.0428 | 0.9543 | 0.9569 | 0.9869 |
       
    * Epochs of model training - EofT - by the best validation accuracy and loss result;   

* #### 3.13. Model 2.6.0 combined evaluation on [256x256] patches (extended train database of grayscaled and noised images)

  * 3.13.1. Method of combined evaluation:     
  ...
  * 3.13.2. Model:
    ...
    * Model v2.5.0 (neither retrained, nor retested via preprocessing v0.6);
  ...
  * 3.13.5. CVL and IAM cumulative evaluation of model v2.5.0:
...
* #### 3.13. Model 2.7.0 training on [256x256] patches (extended train database of ??? images)
* #### 3.13. Model 2.7.0 evaluation on [256x256] patches (extended train database of ??? images)
* #### 3.13. Model 2.7.0 combined evaluation on [256x256] patches (extended train database of ??? images)    
