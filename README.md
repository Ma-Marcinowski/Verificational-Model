...
* #### 3.3. Model v3.1 evaluation on [256x256] patches
  ...
  * 3.3.3. CVL evaluation (epochs of model training - EofT - by the best accuracy result):
   ...
   | **True** | 3 | **0.1494** | **0.9506** | 0.9567 | 0.9445 | 0.0555 | 0.0433 | 0.9452 | 0.9858 |
  
  * 3.3.4. IAM evaluation (epochs of model training - EofT - by the best accuracy result):
  
   | Denoised | EofT | Loss | Acc | TPR | TNR | FPR | FNR | PPV | AUC |
   | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
   | **False** | 3 | 283.7893 | 0.5266 | **0.9883** | **0.0649** | 0.9350 | 0.0116 | 0.5138 | 0.5269 |
   | True | 3 | 0.6610 | 0.9138 | 0.9867 | 0.8408 | 0.1592 | 0.0133 | 0.8611 | 0.9510 |
