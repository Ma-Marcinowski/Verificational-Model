...
* #### 2.3. Model v3.0 evaluation on [256x256] patches
  ...
  * 2.3.4. IAM evaluation (epochs of model training - EofT - by the best validation result):
  ...
  | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
  | **False** | 5 | 265.3726 | 0.5047 | **0.0113** | **0.9979** | 0.0020 | 0.9886 | 0.8478 | NC | 0.5058 |
  | True | 5 | 0.3629 | 0.8835 | 0.9661 | 0.8009 | 0.1990 | 0.0338 | 0.8291 | NC | 0.9603 |
...
* #### 3.3. Model v3.1 evaluation on [256x256] patches
  ...
  * 3.3.3. CVL evaluation (epochs of model training - EofT - by the best accuracy result):
   ...
   | Criterion | EofT | Loss | Acc | TPR | TNR | FPR | FNR | PPV | NPV | AUC |
   | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
   | False | 3 | 0.1835 | 0.9387 | 0.9301 | 0.9474 | 0.0526 | 0.0699 | 0.9464 | NC | 0.9817 |
   | **True** | 3 | **0.1494** | **0.9506** | 0.9567 | 0.9445 | 0.0555 | 0.0433 | 0.9452 | NC | 0.9858 |
  
  * 3.3.4. IAM evaluation (epochs of model training - EofT - by the best accuracy result):
  
   | Denoised | EofT | Loss | Acc | TPR | TNR | FPR | FNR | PPV | NPV | AUC |
   | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
   | **False** | 3 | 283.7893 | 0.5266 | **0.9883** | **0.0649** | 0.9350 | 0.0116 | 0.5138 | NC | 0.5269 |
   | True | 3 | 0.6610 | 0.9138 | 0.9867 | 0.8408 | 0.1592 | 0.0133 | 0.8611 | 0. | 0.9510 |
