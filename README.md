...
* #### 4.6. Model v3.6.2 transfer training on [256x256] patches (extended train database of raw grayscaled images)
  ...
  * 4.6.3. Training:
    ...
    | 3 | CVL | None | 0.2003 | 0.9237 | 0.2253 | 0.9091 | 0.001 (1e-3) | 0.5 |
    | 4 | CVL | None | 0.1865 | 0.9301 | 0.2010 | 0.9207 | 0.0001 (1e-4) | 0.5 |
    | 5 | **CVL** | None | 0.1846 | 0.9310 | **0.2003** | **0.9209** | 0.00001 (1e-5) | 0.5 |
    | 6 | IAM | None | 0.2918 | 0.8903 | 0.2965 | 0.8806 | 0.0001 (1e-4) | 0.5 |
    | 7 | IAM | None | 0.2272 | 0.9094 | 0.2924 | 0.8847 | 0.0001 (1e-4)) | 0.5 |
    | 8 | **IAM** | None | 0.2190 | 0.9131 | **0.2811** | **0.8894** | 0.00001 (1e-5) | 0.5 |
    | 9 | Both | None | 0. | 0. | 0. | 0. | 0.0001 (1e-4) | 0.5 |
    | 10 | ? | None | 0. | 0. | 0. | 0. | ? | ? |
    | 11 | ? | None | 0. | 0. | 0. | 0. | ? | ? |
    | 12 | ? | None | 0. | 0. | 0. | 0. | ? | ? |
