...
xl = BatchNormalization(axis=-1, scale=True, trainable=True)(xl)
left_out = MaxPooling2D(pool_size=(3, 3), strides=2, padding='valid', name='3rdPoolLeft')(xl)
...
xr = BatchNormalization(axis=-1, scale=True, trainable=True)(xr)
right_out = MaxPooling2D(pool_size=(3, 3), strides=2, padding='valid', name='3rdPoolRight')(xr)
